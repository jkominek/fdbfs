...
fs: main.o inflight.o util.o values.pb.o getattr.o lookup.o readdir.o read.o open.o mknod.o unlink.o link.o readlink.o symlink.o setattr.o # write.o rename.o
