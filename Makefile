fs: getattr.o  inflight.o  lookup.o  main.o  read.o  util.o readdir.o open.o mknod.o unlink.o link.o values.pb-c.o readlink.o symlink.o write.o setattr.o rename.o
